...
However, in many situations this assumption is not satisfied: a person might be receiving a short phone call while working on a job, a machine may fail in the midst of processing, and so on.
